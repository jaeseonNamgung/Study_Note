# 웹 폰트
1. webfont :
  -  어떤한 링크, 도메인, 브라우저와 상관없이 웹 페이지 내에서 폰트가 연결되어지는 것이다.
...
<body>
  <h1>웹 폰트</h1>
  <p>
    -  어떤한 링크, 도메인, 브라우저와 상관없이 웹 페이지 내에서 폰트가 연결되어지는 것이다.<br/>
    -  일반적으로 스타일을 이용해서 연결하는 방법 > 내 컴퓨터 내에 설치된 폰트가 존재   
  </p>
</body>
```
...
- 폰트를 두 개 지정할 경우 앞에 폰트가 오류 또는 사용할 수 없느 폰트일 경우 그 다음 지정한 폰트가 지정된다. 
